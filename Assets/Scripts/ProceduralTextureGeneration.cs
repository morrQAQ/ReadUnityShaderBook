...
public class ProceduralTextureGeneration : MonoBehaviour
{
    ...
    void Start()
    {
        var hasRender = gameObject.TryGetComponent<Renderer>(out var renderer);
        material = hasRender ? renderer.sharedMaterial :
            throw new System.Exception("can not find a renderer");
